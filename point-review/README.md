...
Requires Visualizer enabled. The widget itself is [`points.js`](https://github.com/korakot/ui/blob/main/points.js) in [korakot/ui](https://github.com/korakot/ui) (spec: [`points.md`](https://github.com/korakot/ui/blob/main/points.md)).
